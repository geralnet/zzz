...
import net.geral.zzz.xcontroller.gui.configpanel.ConfigPanel;
...
public class ConfigWindow extends JFrame {
	...
	public void load() {
		...
		try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(
			...
			JOptionPane.showMessageDialog(this,
					"Cannot load configuration. Please configure the system.",
	...
	private void save() {
		try (ObjectOutputStream ois = new ObjectOutputStream(
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(this, "Cannot save configuration.",
					"Error", JOptionPane.ERROR_MESSAGE);
			configPanel.setVisible(true);
		}
	}
